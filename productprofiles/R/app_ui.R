        ...
        tabItems(
          ...
          tabItem(
            ...
            HTML('
              ...
              <a type="button" target="_blank" class="btn btn-primary" href="https://shiny.tradestatistics.io/countryprofiles">Country Profiles</a>
              <a type="button" target="_blank" class="btn btn-primary" href="https://shiny.tradestatistics.io/productprofiles">Product Profiles (this site)</a>
