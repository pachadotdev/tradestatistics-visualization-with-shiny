...
##
golem::fill_desc(
  pkg_name = "otsshinyproductprofiles", # The Name of the package containing the App
...
golem::use_favicon("https://shiny.tradestatistics.io/favicon.ico") # path = "path/to/ico". Can be an online file.
