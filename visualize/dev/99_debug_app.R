...
sql_con = otsshinyvisualize::sql_con()

tbl_dtl = function() "yrpc"
inp_r = function() "can"
inp_p = function() "all"
inp_y = function() 2010
inp_d = function() 2000
...
exp_tm_dtl_min_yr <- function() {
  ...
  d <- p_fix_section_and_aggregate(d, col = "trade_value_usd_exp", sql_con = sql_con)

  d2 <- p_colors(d, sql_con = sql_con)
